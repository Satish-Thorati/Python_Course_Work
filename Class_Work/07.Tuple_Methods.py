...
str_tuple = ("Satish", "Is", "Python", "Developer")
print(str_tuple) #('Satish', 'Is', 'Python', 'Developer')
print(type(str_tuple))  # <class 'tuple'>

# Tuple with repeated strings
str_tuple2 = ("apple", "banana", "apple", "cherry")
print(str_tuple2)  #('apple', 'banana', 'apple', 'cherry')
...
str_tup3 = ("Hello", "Satish", "Welcome")
x, y, z = str_tup3
print(x, y, z)  #Hello Satish Welcome


# Tuple Methods:

tuple33 = (1, 2, 3, 4, 4, 34, 2, 2, 2, 4, 2, 2, 4)
print(tuple33) #(1, 2, 3, 4, 4, 34, 2, 2, 2, 4, 2, 2, 4)
