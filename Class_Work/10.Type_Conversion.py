...
dict_d = {1: "Python", 2: "Programming", 3: "Language"}
print(list(dict_d))  # [1, 2, 3]


# Dictionary conversion ('Satish', '41', 'python')
d = [('name', 'Satish'), ('batch', '41'), ('subject', 'python')]
print(dict(d))  # {'name': 'Satish', 'batch': '41', 'subject': 'python'}